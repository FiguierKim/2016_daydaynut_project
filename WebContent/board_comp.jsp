...
<body>
	<div id="wrap">
		<div id="header">
			<div id="header_logo">
				<a href="index.jsp" title="메인 페이지로"><img src="Images/new/logo.png"></a>
			</div>
		...
		<div id="main_m2">
			...
			%>
			<iframe src="post/ListAll_comp.jsp" width="980" height="690"
				scrolling="no" frameborder="0"> </iframe>
			<%
				} else if(login != null && id != null){
				%>
				<iframe src="post/ListAll_comp.jsp?id=<%=id %>" width="980" height="690"
				scrolling="no" frameborder="0"> </iframe>
				<%	
				}else {
			%>
			<iframe src="post/ListAll_comp_view.jsp" width="980" height="690"
				scrolling="no" frameborder="0"> </iframe>
			<%
				}
			%>
