...
<body
	onLoad="MM_preloadImages('Images/header_menu_intro_r.png','Images/header_menu_board_r.png','Images/header_menu_center_r.png')">
	<div id="wrap">
		<div id="header">
			<div id="header_logo">
				<a href="index.jsp"><img src="Images/new/logo.png"></a>
			</div>
			<div id="header_logo2"><img src="Images/new/logo2.png" width="300" height="75">
            </div>
			<div id="header_menu">
				<div id="header_menu2">
					<ul>
		...
		<div id="main">
			<div id="main_info">
				<a href="board_comp.jsp?id=17"><img src="Images/new/main_banner.png" width="679" height="299"></a>
			</div>
			<div id="main_login">
				<div id="login_form">
				<% if( session.getAttribute("USERID") ==null){ %>
					...
					<%}else{ %>
					<jsp:include page="loginForm_after.jsp" flush="false"/>
					<%} %>
				</div>
			</div>
			<div id="bottom">
				<div id="bottom_main">
					<div class="bottom_banner"><img src="Images/new/ban_top.jpg" width="340" height="150"></div>
					<div class="bottom_board"><img src="Images/new/coffee.jpg" width="340" height="150"></div>
					<div class="bottom_banner"><img src="Images/new/tigerNuts.jpg" width="340" height="150"></div>
					<div class="bottom_board"><img src="Images/new/deliver.jpg" width="340" height="150"></div>
				</div>
				<div id="bottom_menu"><img src="Images/new/bottom_menu.png"></div>
